...
const handleMouseMove = (e) => {
  const r = mouseRef.value.getBoundingClientRect();
  x.value = e.clientX - (r.left + Math.floor(r.width / 2));
  y.value = e.clientY - (r.top + Math.floor(r.height / 2));
};
...
onMounted(() => {
  const mouseElem = mouseRef.value;
...
<template>
  <section id="mousemove"  ref="mouseRef" class="tp-category-area p-relative fix pt-120 pb-120">
    <div class="tp-category-shape">
        <img class="shape-1 mousemove__image" :src="category_shape_1" alt="image-title-here">
        <img class="shape-2 mousemove__image" :src="category_shape_2" alt="image-title-here">
        <span class="shape-3">
          ...
          <div class="col-xl-12">
              <div class="tp-category-title-wrapper text-center">
                <span class="tp-section-title__pre">
                    feature <span class="title-pre-color">percubaaan</span>
              ...
              <div class="tp-category-content-wrapper d-flex">
                <div class="tp-category-content one">
                    <div class="tp-category-icon">
                      <img :src="category_icon_1" alt="image-title-here">
                      <h4 class="tp-category-content-title">Consulting</h4>
                    </div>
                </div>
                <div class="tp-category-content two">
                    <div class="tp-category-icon">
                      <img :src="category_icon_2" alt="image-title-here">
          ...
          <div class="col-xl-2 col-lg-2 col-md-4 order-3 order-md-2">
              <div class="tp-category-content-wrapper d-flex">
                <div class="tp-category-content three">
                    <div class="tp-category-icon">
                      <img :src="category_icon_3" alt="image-title-here">
          ...
          <div class="col-xl-5 col-lg-5 col-md-12 order-2 order-md-3">
              <div class="tp-category-content-wrapper d-flex">
                <div class="tp-category-content four">
                    <div class="tp-category-icon">
                      <img :src="category_icon_4" alt="image-title-here">
                      <h4 class="tp-category-content-title">Cyber security</h4>
                    </div>
                </div>
                <div class="tp-category-content five">
                    <div class="tp-category-icon">
                      <img :src="category_icon_5" alt="image-title-here">
              ...
              <div class="tp-offer-all-btn text-center mt-50">
                <p>Bring them together and you overcome the ordinary. 
                  <router-link to="/service-details">
                    View More SErvice <span><i class="fa-regular fa-plus"></i></span>
                  </router-link></p>
              </div>
          </div>
        </div>
