...
import shape_1 from "@/assets/img/about/home-3/shape-4.png";
import about_img_1 from "@/assets/img/about/home-3/img-1.jpg";
import about_img_2 from "@/assets/img/about/home-3/img-2.jpg"; 
...
import about_video_thumb from "@/assets/img/about/home-3/img-3.jpg";
          ...
          <div class="row">
            <div class="col-lg-6">
                <div class="tp-about-3-img p-relative fadeLeft">
                  ...
                  <img class="shape-1" :src="about_img_2" alt="image-title-here" />
                  <div class="shape-2 p-relative">
                      <img :src="about_video_thumb" alt="image-title-here" />
                  ...
                  <img class="shape-3" :src="about_shape_1" alt="image-title-here" />
                  <img class="shape-4" :src="about_shape_2" alt="image-title-here" />
                  <img class="shape-5" :src="about_shape_3" alt="image-title-here" />
                </div>
            </div>
            <div class="col-lg-6">
                <div class="tp-about-3-wrapper">
                  ...
                  <div class="tp-about-3-btn-inner d-flex flex-wrap">
                      <div class="tp-about-btn ">
                        <router-link class="tp-btn" to="/about">Our History <i class="fa-regular fa-arrow-right-long"></i>
                        </router-link>
                      </div>
                      <div class="tp-about-3-year">
                        <p>
                            ...
                            <br>
                            <span>
                              mayor, since {{ today }} {{ getMonthName(date) }}, {{ fullYear }}
                            </span>
                        </p>
                      </div>
                  </div>
