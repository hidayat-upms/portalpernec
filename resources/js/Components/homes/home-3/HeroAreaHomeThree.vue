...
<template>
  <section class="tp-hero-3-area p-relative fix">
          ...
          <div class="tp-hero-3-wrapper p-relative">
            <div class="container">
                <div class="tp-hero-3-shape">
                  ...
                  <img class="shape-2" :src="slider_shape_2" alt="image-title-here">
                  <img class="shape-3" :src="slider_shape_3" alt="image-title-here">
                </div>
                <div class="tp-hero-3">
                        ...
                        <div class="tp-hero-3-content p-relative">
                            <div class="tp-hero-3-title-wrapper">
                              ...
                              <div class="tp-hero-3-btn">
                                  <router-link class="tp-btn-2" to="/about">LEARN MORE</router-link>
                              </div>
                            </div>
                        </div>
                      </div>
    ...
    <div class="tp-hero-3-nav d-none d-xl-block">
        <button type="button" @click="handlePrev" class="hero-button-prev-1 tp-btn-hover-clear alt-color"><i class="fa-regular fa-arrow-left"></i>
        <b></b>
        </button>
        <button type="button" @click="handleNext" class="hero-button-next-1 tp-btn-hover-clear alt-color"><i class="fa-regular fa-arrow-right"></i>
        <b></b>
        </button>
    </div>
