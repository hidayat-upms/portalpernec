...
import shape_1 from "@/assets/img/blog/shaep-2.png";
import shape_2 from "@/assets/img/blog/shaep-2.png";
      ...
      <div class="row">
        <div class="col-xl-12">
          <div class="tp-blog-3-title-wrapper text-center">
            <span class="tp-section-title__pre"> blog <span class="title-pre-color">IT Solutions</span>
        ...
        <div v-for="(item, i) in blog_data" :key="i" class="col-xl-4 col-md-6">
          <div class="tp-blog-3-wrapper mb-30 OneByOne">
            <div class="tp-blog-3-thumb">
              ...
              <div class="tp-blog-3-user">
                <img :src="item.user" alt="image-title-here">
            ...
            <div class="tp-blog-3-content">
              <div class="tp-blog-date">
                ...
                <span>-</span>
                <span><i class="fa-sharp fa-solid fa-comments"></i> Coments ({{ item.comments }})</span>
              </div>
              <h3 class="tp-blog-3-title">
                <router-link to="/blog-details"> <span v-html="item.title"></span></router-link>
                </h3>
            </div>
            <div class="tp-blog-3-btn d-flex justify-content-between">
              <div class="read-more p-relative">
                <router-link to="/blog-details">Read More <span>
